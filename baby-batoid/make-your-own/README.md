...
these files are for ordering from JLCPCB and 3d printing/laser cutting your own case
...
vial firmware is flashed with the QMK Toolbox, hold BOOT1 on the back of the keyboard while plugging it in and then select the file and hit flash
